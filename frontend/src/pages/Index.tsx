...
import { useUndergarmentsBackend } from '@/hooks/useUndergarmentsBackend';
import { Crown, Plus, Trophy, Sparkles, Loader2 } from 'lucide-react';
        ...
        {!isAuthenticated ? (
          <div className="text-center py-12">
            ...
            <p className="text-lg text-muted-foreground mb-6 max-w-md mx-auto">
              Please log in to manage your undergarment collection and track your achievements!
            </p>
            <Link to="/login">
          ...
          <>
            {loading ? (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">Loading your undergarment collection...</p>
              </div>
            ) : (
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="hall" className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <AddUnderwearForm onAdd={addUndergarment} />
                    
                    {activeUnderwear.map((item) => (
                      <UnderwearCard
                        key={item.id}
                        underwear={item}
                        onWash={washUndergarment}
                        onRetire={retireUndergarment}
                      />
                    ))}
                  </div>
